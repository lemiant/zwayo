(function ($) {
     ...
     * @class
     */
    Appery = $t = window.Apperyio = window.Appery = apperyFunction;
...
//            dataType: 'json',
    ...
    Appery.ApperyWrapper = $t.TiggziWrapper = $t.TiggrWrapper =
        $t.createClass(null, /** @lends Appery.ApperyWrapper.prototype */ {
            ...
            init: function (componentId, options) {
                this.__element = $("#" + Appery.CurrentScreen).find('[dsid="' + componentId + '"]:eq(0)');
                        ...
                        if (isRenderedmarker == "true" && isTemplate != "true") {
                            ...
                            $.each(_that.supportedMarkerEvents, function (index, event) {
                                google.maps.event.addListener(marker, event, function () {
                                    $("#" + markerDomElemId).trigger(event, arguments);
                                });
                            });
    ...
    Appery.ApperyMobileAudioComponent = $t.TiggziMobileAudioComponent = $t.TiggrMobileAudioComponent =
        $t.createClass($t.ApperyWrapper, /** @lends Appery.ApperyMobileAudioComponent.prototype */ {
			...
			isAndroidPlatform : function(){
				return Appery.getTargetPlatform() == "A";
			},
    ...
    Appery.ApperyMobileCarouselComponent = $t.TiggziMobileCarouselComponent = $t.TiggrMobileCarouselComponent =
        $t.createClass($t.ApperyWrapper, /** @lends Appery.ApperyMobileCarouselComponent.prototype */ {
            ...
            initializeCarousel: function () {
                var _that = this,
                    currentPage = $("#" + Appery.CurrentScreen),
    ...
    $t.adjustContentHeightWithPadding = function (page) {
        if (!page) {
            $("[data-role='page']").each(function (ind, elt) {
                Appery.adjustContentHeightWithPadding(elt);
            });
            return;
        }
