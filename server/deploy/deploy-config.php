<?php
//THIS IS CUSTOM
$PRE_SYNC_COMMANDS = array(
    "mv /var/www/staging/server/active_settings.php /var/www/staging/server/dev_settings.php",
 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', '8GxOpeP23o9rNUC4jsnxFAElzYN88Si3b6b9');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'git@github.com:lemiant/zwayo.git');
 ...
 */
define('TARGET_DIR', '/var/www/public_html');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/var/www/staging/');
 ...
 */
define('BACKUP_DIR', '/var/www/backup/');
